...
class WidgetTypeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.dropdownValue.value = options[0];
...
//         style: const TextStyle(color: Colors.blue),
                      ...
                      items:
                        ...
                        return DropdownMenuItem<String>(
                          value: value,
                          child: QcText.bodyText1(value,
                              // fontColor: Theme.of(context)
                              //     .colorScheme
                              //     .onPrimaryContainer
                              fontColor: value == controller.dropdownValue.value
                                  ? Theme.of(context)
                                      .colorScheme
                                      .onSurfaceVariant
                                  : null),
                    ...
                    DecoratedBox(
                      ...
                      child: Stack(
                        ...
                        children: const <Widget>[
                          ...
                          Icon(Icons.star,
                              size: 50,
                              color: Colors.red), // align center right
                          Positioned(
                              left: 0,
                              top: 0,
                          ...
                          return Stack(
                            children: <Widget>[
                              Positioned(
                                  ...
                                  top: 0,
                                  child:
                                      Icon(Icons.star, size: 50)), // left, top
                              Positioned(
